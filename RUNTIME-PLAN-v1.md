# RIVET Runtime and Memory Plan v1
...
Source precedent: [QSOL-MESH PR #3 head e38fa71](https://github.com/QSOLKCB/QSOL-MESH/commit/e38fa71f1d8c1489bf4adf3538f2716c531e86a9).
...
Donors: [GALAXY v0.4.0 source 6f17a73](https://github.com/QSOLKCB/GALAXY/commit/6f17a734b9241359d36a9bf3d208b8527a456327) and [IGM execution campaigns @ 9b2df31](https://github.com/QSOLKCB/igm/blob/9b2df317a463f53ebb9e71b9a3bac0610a8ba5c6/docs/EXECUTION_CAMPAIGNS.md).
...
Source precedent: [GALAXY v0.6.0 source fa1c76f](https://github.com/QSOLKCB/GALAXY/commit/fa1c76fb49664ae4cdd6dc090cccd702399c2b60).
...
Source precedent: [IGM execution campaigns @ 9b2df31](https://github.com/QSOLKCB/igm/blob/9b2df317a463f53ebb9e71b9a3bac0610a8ba5c6/docs/EXECUTION_CAMPAIGNS.md).

## P5 — Result identity != execution-plan identity

Where semantics are invariant, every **successful execution** for the same semantic inputs and declared profile must produce the same correctness result regardless of worker count, chunk size/count, resident memory budget, cache allocation, or optional SIMD path. If a declared budget cannot satisfy the operation's minimum representation, explicit resource exhaustion/unavailability is a permitted distinct failure outcome; it is not a conflicting correctness result.
...
Donors: [GALAXY v0.5.0 source b2e8603](https://github.com/QSOLKCB/GALAXY/commit/b2e860309a04d7591c86f71d2b4ab1e5eec4c4d7) and [OPT v1.0.0 source 41e2fc3](https://github.com/QSOLKCB/OPT/commit/41e2fc3677469839fb298dedefd0ce72caebcc68).
...
Useful donor records: [OPT-REDUCE-001 @ 3441c6c](https://github.com/QSOLKCB/OPT/blob/3441c6ceacd4a6ca43ec46de758e2d5bc23d8ca7/optimizations/OPT-REDUCE-001-early-working-set-reduction.md) and [OPT-INC-001 @ 3441c6c](https://github.com/QSOLKCB/OPT/blob/3441c6ceacd4a6ca43ec46de758e2d5bc23d8ca7/optimizations/OPT-INC-001-signature-bound-incremental-execution.md).
...
Donors: [OPT-INC-001 @ 3441c6c](https://github.com/QSOLKCB/OPT/blob/3441c6ceacd4a6ca43ec46de758e2d5bc23d8ca7/optimizations/OPT-INC-001-signature-bound-incremental-execution.md) and [OPT-FAN-001 @ 3441c6c](https://github.com/QSOLKCB/OPT/blob/3441c6ceacd4a6ca43ec46de758e2d5bc23d8ca7/optimizations/OPT-FAN-001-shared-materialization-fanout.md).
...
Source: [OPT-COAL-001 @ 3441c6c](https://github.com/QSOLKCB/OPT/blob/3441c6ceacd4a6ca43ec46de758e2d5bc23d8ca7/optimizations/OPT-COAL-001-concurrent-duplicate-work-coalescing.md).
...
Source precedent: [QSOLKCB/C64 architecture @ e8875f2](https://github.com/QSOLKCB/C64/blob/e8875f2f6d0872a94094381e054c27fba3894c0a/docs/ARCHITECTURE.md).
